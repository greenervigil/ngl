  setTimeout(function(){
	...
	$("html").on("click", function(e){
		...
		/*$("#requestSampleDropDowncontainer .collapse").each(function(){
	...
	$(function() {
		...
		/*jQuery('body').bind('click', function(e) {
		    if(jQuery(e.target).closest('#requestSampleDropDowncontainer').length == 0) {
		        // click happened outside of .navbar, so hide
		        var opened = jQuery('.navbar-collapse').hasClass('collapse in');
		        if ( opened === true ) {
		        	jQuery('.requestSampleBtnDropDown').addClass('collapsed');
		            jQuery('.requestSampleSubmenu').collapse('hide');
		        }
		    }
		});*/
