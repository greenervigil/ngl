(function ($) {
    $.fn.extend({
        arrayTypeAhead: function (options) {
            var defaults = {
                textBox: this,
                    ...
                    if (e.keyCode != 40 && e.keyCode != 38 && e.keyCode != 13 && e.keyCode != 39 && e.keyCode != 37) {
                        if (searchBox.val() != "") {
                            ...
                            if(o.data.length > 0)
                            {
                                ...
                                {
                                    for (i = 0; i < o.data.length; i++) {
                                        if (o.data[i].name.toUpperCase().indexOf(searchBox.val().toUpperCase()) >= 0 || o.data[i].aka.toUpperCase().indexOf(searchBox.val().toUpperCase()) > -1) {
                                            autoSuggestions.append(
                     			                "<div id='suggestion" + matches + "' class='suggestion' >" + o.data[i].name + "</div>"
                     		                );
                                            matches++;
                                        }
                                    }
