...
function printSearchResultsPage(cssPath) {
    ...
    windowObject.document.writeln('<HTML>\n<HEAD>\n<link href="//cdn.cengage.com/css/apps/search/reset.css" rel="stylesheet" type="text/css" /><link href="//cdn.cengage.com/css/sites/cengage/header_footer.css" rel="stylesheet" type="text/css" /><link href="/css/search/style.css" rel="stylesheet" type="text/css" /><link href="' + cssPath + '" rel="stylesheet" type="text/css" /> \n </HEAD> \n <BODY><header>');
    var divContent = document.getElementById("printHeader");
    if (divContent) {
        windowObject.document.writeln(divContent.innerHTML);
    }
    windowObject.document.writeln('</header><aside class="breadCrumbs">');
    divContent = getClass("breadCrumbs");
    if (divContent) {
        windowObject.document.writeln(divContent.innerHTML);
    }
    windowObject.document.writeln('</aside><article><section class="resultsListHeader">');
    divContent = getClass("resultsListHeader").getElementsByTagName("H1")[0];
    if (divContent) {
        windowObject.document.writeln(divContent.innerHTML);
    }

    windowObject.document.writeln('</section><section class="resultsList">');
    divContent = getClass("resultsList");
    if (divContent) {
        windowObject.document.writeln(divContent.innerHTML);
    }
    windowObject.document.writeln('</section></article></BODY>\n</HTML>');
