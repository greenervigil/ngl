...
var s_account="cengagengl,cengageglobal"
...
s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,flv,m4v,tgz,gz,csv,xml,wmv,doc,pdf,xls,mrc,txt,ogg,docx,xlsx,ppt,docm,xlsm,pptx,pptm,rar"
...
/* Setting Global Variables */
	s.pageName=document.title // required - Fill this in with the page's title
	s.server=window.location.protocol + "//" + window.location.host // required - Fill this in with the server's URL
	s.prop3=document.title // required - Document Title -  Fill this in with the page's title
	s.prop4=document.URL // required - Document URL - Fill this in with the page's URL
	s.prop10=<!--#echo var="REMOTE_ADDR"--> // optional but reserved - IP Address
	s.eVar10=<!--#echo var="REMOTE_ADDR"--> // optional but reserved - IP Address
...
/************************** START - FUNCTION FOR SETTING PLUGIN CALLS *************************/
function s_doPlugins(s) {

	/* Add calls to plugins here */
	s.campaign=s.getQueryParam('cid'); // required - Campaigns/Promotions
	s.prop1=s.getQueryParam('cid'); // required - Campaigns/Promotions
	s.prop2=s.getNewRepeat(7,'s_getNewRepeat'); // required - Return User or New User
	s.eVar2=s.getNewRepeat(7,'s_getNewRepeat');
	
}
s.doPlugins=s_doPlugins;
s.loadModule("Media");  
/************************** END - FUNCTION FOR SETTING PLUGIN CALLS *************************/
...
s.visitorNamespace="cengagelearning"
s.trackingServer="cengagelearning.112.2o7.net"
