...
(function($) {
    ...
    var defaults = {
        ...
        buttonNextHTML: '<button id="rsbNext" class="ui-button ui-widget ui-state-default ui-button-icon-only" title="next"></button>',
        buttonPrevHTML: '<button id="rsbPrev" class="ui-button ui-widget ui-state-default ui-button-icon-only" title="previous"></button>',
