...
var s_account="cengagenglstatic,cengagenglglobal"
...
s.formList="" // Add in the specific form names that need to be tracked
s.trackFormList=true
s.trackPageName = true
s.useCommerce = true
s.varUsed = "prop5,eVar5" // Set the variable to be used in the Form Analysis tracking
s.eventList = "event11,event12,event13" //Form Abandon, Form Success, Form Error
...
/************************** START - SETTING PLUGIN CALLS *************************/
function s_doPlugins(s) {
	/* Add calls to plugins here */
	s.prop2=s.getNewRepeat(7,'s_getNewRepeat'); // Return User or New User
	s.eVar2=s.prop2;
